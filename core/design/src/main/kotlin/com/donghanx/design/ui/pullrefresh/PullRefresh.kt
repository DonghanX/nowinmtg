 ...
 *
 * Also note that material 3 doesn't include PullRefresh at this time. As suggested the best way to
 * use PullRefresh with M3 currently is to fork the M2 logic in the meantime. Once PullRefresh is
 * ready in M3 I will update and fully migrate to M3 implementation
 *
